...
public class PhraseParserPluginCheckIsSameElementsTest {
	...
	public void testProcess() {
		String query = "pe>10";
		String fileName = query.hashCode()+"-PhraseParserPluginCheckIsSameElements";
		...
		PhraseParserPluginAbstract checkIsSameElements = new  PhraseParserPluginCheckIsSameElements();
		checkIsSameElements.init();
		ArrayList<ArrayList<SemanticNode>> actual = checkIsSameElements.process(annotation);
