...
public class PhraseParserPluginMatchIndexAndKeywordsTest {
	...
	public void testProcess() {
		String query = "pe>10";
		String fileName = query.hashCode()+"-PhraseParserPluginMatchIndexAndKeywords";
		...
		PhraseParserPluginAbstract matchIndexAndKeywords = new  PhraseParserPluginMatchIndexAndKeywords();
		ArrayList<ArrayList<SemanticNode>> actual = matchIndexAndKeywords.process(annotation);
