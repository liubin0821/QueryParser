...
public class PhraseParserPluginCalculateScoreTest {
	...
	public void testProcess() {
		String query = "pe>10";
		String fileName = query.hashCode()+"-PhraseParserPluginCalculateScore";
		...
		PhraseParserPluginAbstract calculateScore = new  PhraseParserPluginCalculateScore();
		ArrayList<ArrayList<SemanticNode>> actual = calculateScore.process(annotation);
