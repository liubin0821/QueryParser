...
import service.provider.QueryClass.ClassLevel;
...
public class StockQueryClassifierByIndex {
	...
	public static void init() {
		...
		if (qcRoot != null){
			if (!QUERY_CLASS_SET.isEmpty())
				getQueryClsSet(qcRoot);
			return  ;
		}
	 ...
	 * @rm.param qc
	 */
	private static void getQueryClsSet(QueryClass qc) {
	 ...
	 * @return
	 */
	private static QueryClass parseClassifier(List<QueryClass> qcList) {
		...
		if (maxOfFirst == null) {
			System.err.println("[StockQueryClassifierByIndex] : " + "maxOfFirst is null");
			return null;
		}
	 ...
	 * @return
	 */
	private static QueryClass getOtherQueryClass() {
...
//	public static HashMap<String, String> CLASSIFY_MAP_ = new HashMap<String, String>();
	private static HashSet<QueryClass> QUERY_CLASS_SET = new HashSet<QueryClass>();
//	private static ArrayList<Node> xmlNodes = new ArrayList<Node>();
//	private static QueryParser qp;
	private static QueryClass qcRoot ;
