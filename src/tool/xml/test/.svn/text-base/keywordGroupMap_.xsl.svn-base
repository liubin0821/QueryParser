...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="Config">
    ...
    <xsl:for-each select="KeywordGroup">
      ...
      <!-- -->
      <bean class="com.myhexin.qparser.phrase.KeywordGroup">
        <xsl:attribute name="id">
          <xsl:value-of select="concat(&#39;KeywordGroup&#39;,@id)" />
        </xsl:attribute>
        ...
        <property name="_keywords" refType="container">
      ...
      <bean class="com.myhexin.qparser.phrase.KeywordGroupMap">
        <xsl:attribute name="id">
          <xsl:value-of select="concat(&#39;keywordGroupMap_&#39;,@id)" />
        </xsl:attribute>
